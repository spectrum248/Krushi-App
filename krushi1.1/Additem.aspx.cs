...
namespace krushi1._1
{
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            if (TextBox1.Text != "" && DropDownList1.SelectedValue != "" && TextBox2.Text != "" && TextBox3.Text != "" && TextBox4.Text != "" && Image1.ImageUrl != "")
            {
    
                    string str = "insert into ProductDetails (productid,productname,category,price,productpic,Description) values('" + TextBox4.Text + "','" + TextBox1.Text + "','" + DropDownList1.SelectedValue + "','" + TextBox2.Text + "','" + Image1.ImageUrl + "','" + TextBox3.Text + "')";
